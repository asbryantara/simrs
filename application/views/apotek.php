    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <a href="<?= base_url('apotek/resep_selesai') ?>" class="btn btn-primary"><i class="fa fa-eye"> </i> Resep Selesai</a>
                ...
                ?>
                  <tr <?php if($cito == 1)echo 'style="background-color: #FFD5D5"' ?>>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url('apotek/resep/'.$p->id_kunjungan) ?>" class="btn btn-primary btn-xs"><i class="fa fa-medkit"> </i> Resep</a>
