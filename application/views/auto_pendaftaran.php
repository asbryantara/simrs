			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<?php if ($px['alergi_px']) : ?>
							<h3 class="text-red box-title pull-right" id="alergi"><i class="fa fa-warning"> </i> ALERGI <?= $px['alergi_px'] ?></h3>
						<?php endif ?>
					</div>
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="no_rm" class="form-control" id="no_rm" value="<?= $px['no_rm'] ?>" readonly>
							...
							<div class="col-sm-4">
								<input type="text" name="nama_px" class="form-control" id="nama_px" value="<?= $px['nama_px'] ?>" disabled>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="form-control" id="alamat_px" disabled=""><?= $px['alamat_px'] ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="ttl" class="form-control" value="<?= $px['tempat_lahir_px'] . ', ' . $px['tgl_lahir_px'] ?>" disabled="">
								<input type="hidden" id="biday" value="<?= $px['tgl_lahir_px'] ?>">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea name="anamnesa" id="anamnesa" class="form-control" rows="4" required="" autofocus=""></textarea>
							</div>
	...
	$(document).ready(function() {
		...
		*/
		...
		function actTekananDarah(td) {
			if (td == 'Normal') {
				$('#td').removeClass().addClass('text-green').html('<b>' + td + '</b>');
				$('#resultTd').val(1);
			} else if (td == 'Elevated') {
