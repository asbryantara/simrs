    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
              <table class="table table-hover table-striped ">
                ...
                <tr>
                  ...
                  <td width="1">:</td>
                  <td><?php if($kunj['jk_px'] == 1){echo 'Laki-laki';}else{echo 'Perempuan';} ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="1">:</td>
                  <td><?php if($kunj['asuransi_px'] == 1){echo 'Umum';}elseif($kunj['asuransi_px'] == 2){echo 'BPJS Kesehatan';}else{echo $kunj['asuransi_lain_px'];} ?></td>
                </tr>
            ...
            <div class="box-body">
              <table class="table table-hover table-striped ">
                ...
                <tr>
                  ...
                  <td width="1">:</td>
                  <td><?php if($kunj['merokok'] == 1){echo 'Jarang/Tidak Pernah';}elseif($kunj['merokok'] == 2){echo 'Kadang-kadang';}else{echo 'Sering';} ?></td>
                </tr>

                <tr>
                  <td width="200">Aktivitas Fisik</td>
                  <td width="1">:</td>
                  <td><?php if($kunj['aktivitas_fisik'] == 1){echo 'Jarang/Tidak Pernah';}elseif($kunj['aktivitas_fisik'] == 2){echo 'Kadang-kadang';}else{echo 'Sering';} ?></td>
                </tr>
                
                 <tr>
                  <td width="200">Riwayat Keluarga dengan Stroke</td>
                  <td width="1">:</td>
                  <td><?php if($kunj['riwayat_kel_stroke'] == 1){echo 'Ya';}else{echo 'Tidak';} ?></td>
                </tr>
                
                <tr>
                  <td width="200">Riwayat Keluarga dengan DM</td>
                  <td width="1">:</td>
                  <td><?php if($kunj['riwayat_kel_dm'] == 1){echo 'Ya';}else{echo 'Tidak';} ?></td>
                </tr>

                <tr>
                  <td width="200">Risiko Stroke</td>
                  <td width="1">:</td>
                  <td><?php if($kunj['risiko_stroke'] == 1){echo '<span class="text-success"><i class="fa fa-check"> </i> <b>Resiko Rendah Sroke</b></span>';}elseif($kunj['risiko_stroke']==2){echo '<span class="text-warning"><i class="fa fa-warning"> </i> <b>Resiko Sedang Sroke</b></span>';}elseif($kunj['risiko_stroke']==3){echo '<span class="text-red"><i class="fa fa-warning"> </i> <b>Resiko Tinggi Sroke</b></span>';}else{
                    echo '';
                  } ?></td>
                </tr>
          ...
          <div class="box box-primary <?php if($status_lab > 0){echo 'hidden';} ?>">
            <div class="box-header with-border">
          ...
          <div class="box box-primary  <?php if($status_rad > 0){echo 'hidden';} ?>">
            <div class="box-header with-border">
          ...
          <div class="box box-primary  <?php if($status_diag == 0){echo 'hidden';} ?>">
            <div class="box-header with-border">
            ...
            <div class="box-body">
              <table class="table table-hover table-striped ">
                ...
                <tbody>
                  <?php foreach($dx as $d): ?>
                  <tr>
                    <td><?php if($d->jenis == 1){echo 'Diagnosis Primer';}elseif($d->jenis == 2){echo 'Diagnosis Sekunder';}else{echo 'Diagnosis Lainnya';} ?></td>
          ...
          <div class="box box-primary  <?php if($status_resep == 0){echo 'hidden';} ?>">
            <div class="box-header with-border">
