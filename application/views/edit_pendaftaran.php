  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <?= form_open(base_url('pendaftaran/update'), ['class'=>'form-horizontal']) ?>
         <div class="col-md-12">
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" name="sistol" id="sys" class="form-control" placeholder="Systole" value="<?= $kunj['sistol'] ?>" required="">
                    <input type="hidden" name="resultTd" id="resultTd" value="<?= $kunj['td'] ?>">
                    <small id="td"></small>
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="diastol" id="dias" class="form-control" placeholder="Diastole" value="<?= $kunj['diastol'] ?>" required="">
                  </div>
                  
                   <label class="col-sm-2 control-label">Tinggi / Berat Badan</label>

                  <div class="col-sm-2">
                    <input type="text" name="tb" id="tb" class="form-control" placeholder="tinggi badan (m)" value="<?= $kunj['tb'] ?>" required="">
                    <input type="hidden" name="resultImt" id="resultImt" value="<?= $kunj['imt'] ?>">
                    <small id="imt"></small>
                  </div>
                  <div class="col-sm-2">
                    <input type="text" name="bb" id="bb" class="form-control" placeholder="berat badan (kg)" value="<?= $kunj['bb'] ?>" required="">
                  </div>
