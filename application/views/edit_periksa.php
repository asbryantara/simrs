      ...
      <div class="row">
        ...
        <?= form_open(base_url('klinik/update'), ['class'=>'form-horizontal']) ?>
         <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="merokok" id="merokok" class="form-control" required="" disabled>
                      ...
                      <option value="1" <?php if($kunj['merokok']==1){echo 'selected';} ?>>Jarang/Tidak Pernah</option>
                      <option value="2" <?php if($kunj['merokok']==2){echo 'selected';} ?>>Kadang-Kadang</option>
                      <option value="3" <?php if($kunj['merokok']==3){echo 'selected';} ?>>Sering</option>
                    </select>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <select name="aktivitas_fisik" id="aktivitas_fisik" class="form-control" required="" disabled>
                      <option value="">--pilih--</option>
                      <option value="1" <?php if($kunj['aktivitas_fisik']==1){echo 'selected';} ?>>Jarang/Tidak Pernah</option>
                      <option value="2" <?php if($kunj['aktivitas_fisik']==2){echo 'selected';} ?>>Kadang-Kadang</option>
                      <option value="3" <?php if($kunj['aktivitas_fisik']==3){echo 'selected';} ?>>Sering</option>
                    </select>
                  </div>
                </div>
          ...
          <div class="box box-primary <?php if($kunj['id_lab'] == null){echo 'hidden';} ?>" id="lab">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pemeriksaan Lab</h3>
              <input type="hidden" name="dataLab" id="dataLab" value="<?php if($kunj['id_lab'] != null){echo '1';}else{echo '0';} ?>">
            </div>
            <div class="box-body">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="widal" id="widal" class="form-control">
                    <option value="">-- pilih --</option>
                    <option value="0" <?php if($kunj['widal'] == '0'){echo 'selected';} ?>>Negatif</option>
                    <option value="1" <?php if($kunj['widal'] == '1'){echo 'selected';} ?>>Positif</option>
                  </select>
          ...
          <div class="box box-primary <?php if($kunj['id_radiologi'] == null){echo 'hidden';} ?>" id="rad">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pemeriksaan Radiologi</h3>
              <input type="hidden" name="dataRad" id="dataRad" value="<?php if($kunj['id_radiologi'] != null){echo '1';}else{echo '0';} ?>">
            </div>
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="jenis_pemeriksaan" class="form-control">
                    <option <?php if($kunj['jenis_pemeriksaan'] == 'X-Ray Umum'){echo 'selected';} ?>>X-Ray Umum</option>
                    <option <?php if($kunj['jenis_pemeriksaan'] == 'USG'){echo 'selected';} ?>>USG</option>
                    <option <?php if($kunj['jenis_pemeriksaan'] == 'CT-Scan'){echo 'selected';} ?>>CT-Scan</option>
 ...
 -->
                ...
                <div class="col-sm-4">
                  ...
                  <table>
                    <tr>
                      <td style="width: 70%;">
                        <input type="text" name="diagnosa1" class="form-control"  id="diagnosa1" placeholder="Diagnosis Primer" value="<?= $dx1['nama_diagnosa'] ?>">
                      </td>
                      <td></td>
                      <td style="width: 30%;">
                        <input type="text" name="kode_diagnosa1" class="form-control"  id="kode_diagnosa1" value="<?= $dx1['kode_diagnosa'] ?>" <?php if(!empty($dx1['kode_diagnosa'])){echo 'readonly';} ?> >
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <input type="text" name="diagnosa2" class="form-control"  id="diagnosa2" placeholder="Diagnosis Sekunder" value="<?= $dx2['nama_diagnosa'] ?>">
                      </td>
                      <td></td>
                      <td>
                        <input type="text" name="kode_diagnosa2" class="form-control" id="kode_diagnosa2" value="<?= $dx2['kode_diagnosa'] ?>" <?php if(!empty($dx2['kode_diagnosa'])){echo 'readonly';} ?> >
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <input type="text" name="kode_diagnosa3" class="form-control" id="kode_diagnosa3" value="<?= $dx3['kode_diagnosa'] ?>" <?php if(!empty($dx3['kode_diagnosa'])){echo 'readonly';} ?> >
                      </td>
                    </tr>
                  </table>
            ...
            <div class="box-footer">
              ...
              ?>
              <center><h3 id="res-str" class="<?= $kelas ?>"><?= $isi ?></h3></center>
          ...
          <center>
               ...
               <button type="button" id="btn-lab" class="btn btn-info btn-sm <?php if($kunj['id_lab'] != null){echo 'hidden';} ?>">Tambah Data Lab</button>
               <button type="button" id="btn-lab-del" class="btn btn-danger btn-sm <?php if($kunj['id_lab'] == null){echo 'hidden';} ?>">Hapus Data Lab</button>
               <button type="button" id="btn-rad" class="btn btn-info btn-sm <?php if($kunj['id_radiologi'] != null){echo 'hidden';} ?>">Tambah Data Radiologi</button>
               <button type="button" id="btn-rad-del" class="btn btn-danger btn-sm <?php if($kunj['id_radiologi'] == null){echo 'hidden';} ?>">Hapus Data Radiologi</button>
    ...
    */
    ...
    function diagnosa_rekomendasi(){
      ...
      if(Gd == 1){
        ...
        $('.dxGd').remove();
        $('#dx_rekomendasi').append(`<div class="dxGd"> <li> `+namaGd+` </li> <br></div>`);
        // $('#dx_rekomendasi').append(`<div class="dxGd"> <input type="checkbox" name="dx_rek[]" class="flat-red dxRekGd" value="`+kodeGd+`"> `+namaGd+` <br></div>`);
      }else{
        $('.dxGd').remove();
      }
    ...
    $(document).on('click', '.deleteResep', function(){
      ...
      $.ajax({
        ...
        type: 'POST',
        dataType: 'JSON',
        data: {id:id, jumlah:jumlah, id_obat:id_obat},
        success:function(data){
          if(data == 1){
            showResep();
          }
    ...
    // function replaceDiagnosa(){
    //   var dx = $('#diagnosa').html();
    //   var dxEx = dx.split(', ');
    //   if(dxEx.includes('Diabetus Mellitus')){
    //     $('.dxRekGd').iCheck('check');
    //     dxEx.splice( dxEx.indexOf('Diabetus Mellitus'), 1);
    //   }

    //   if(dxEx.includes('Hypotensi')){
    //     $('.dxRekTd').iCheck('check');
    //     dxEx.splice( dxEx.indexOf('Hypotensi'), 1);
    //   }

    //   if(dxEx.includes('Pre Hypertensi')){
    //     $('.dxRekTd').iCheck('check');
    //     dxEx.splice( dxEx.indexOf('Pre Hypertensi'), 1);
    //   }

    //   if(dxEx.includes('Hypertensi')){
    //     $('.dxRekTd').iCheck('check');
    //     dxEx.splice( dxEx.indexOf('Hypertensi'), 1);
    //   }
