              ...
              <tbody>
                <?php foreach($pendaftaran as $p): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('pendaftaran/detail/'.$p->id_kunjungan) ?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                      <a href="<?= base_url('pendaftaran/edit/'.$p->id_kunjungan) ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                      <a href="<?= base_url('pendaftaran/delete/'.$p->id_kunjungan) ?>" class="btn btn-danger btn-xs" onclick="return konfirmasi()"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
