...
?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="widal" id="widal" class="form-control">
                    <option value="" <?php if($kunj['widal'] == ''){echo 'selected';} ?>>-- pilih --</option>
 ...
 -->
          ...
          <center>
               ...
               <button type="button" id="btn-lab" class="btn btn-info btn-sm <?php if($kunj['id_lab'] != null){echo 'hidden';} ?>"><i class="fa fa-plus"> </i> Tambah Data Lab</button>
               <button type="button" id="btn-lab-del" class="btn btn-danger btn-sm <?php if($kunj['id_lab'] == null){echo 'hidden';} ?>"><i class="fa fa-times"> </i> Hapus Data Lab</button>
               <button type="button" id="btn-rad" class="btn btn-info btn-sm <?php if($kunj['id_radiologi'] != null){echo 'hidden';} ?>"><i class="fa fa-plus"> </i> Tambah Data Radiologi</button>
               <button type="button" id="btn-rad-del" class="btn btn-danger btn-sm <?php if($kunj['id_radiologi'] == null){echo 'hidden';} ?>"><i class="fa fa-times"> </i> Hapus Data Radiologi</button>
