        ...
        <div class="col-md-12">
          <div class="box box-primary">
           <div class="box-header">
              <h3 class="box-title">Riwayat Hasil Pemeriksaan Radiologi</h3>
          </div>
          <div class="box-body">
            <table class="table table-hover table-striped table-bordered" id="example1">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('penunjang/edit_rad/'.$p->id_radiologi.'/'.$p->status_kunjungan) ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"> </i> Edit</a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
