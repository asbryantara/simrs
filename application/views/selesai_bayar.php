    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <a href="<?= base_url('kasir') ?>" class="btn btn-primary"><i class="fa fa-eye"> </i> Belum Pembayaran</a>
                ...
                ?>
                  <tr >
                    ...
                    <td>
                      ...
                      <a href="<?= base_url('kasir/bayar/'.$p->id_kunjungan) ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"> </i> Lihat</a>
