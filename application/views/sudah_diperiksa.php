    ...
    <section class="content">
      ...
      <div class="row">
       ...
       <div class="col-md-12">
          ...
          <a href="<?= base_url('klinik') ?>" class="btn btn-primary"><i class="fa fa-eye"> </i> Belum Diperiksa</a>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
           <div class="box-header">
              <h3 class="box-title">Daftar Pasien Sudah Diperiksa</h3>
          </div>
          <div class="box-body">
            <table class="table table-hover table-striped table-bordered" id="example1">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('klinik/edit/'.$p->id_kunjungan) ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"> </i> Edit</a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
