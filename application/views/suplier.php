...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-circle-o"></i> &nbsp; Data suplier
        <small></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="judul-modal">Tambah Data suplier</h4>
            </div>
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="nama_suplier" id="nama_suplier" class="form-control" autocomplete="off">
                </div>
              </div>
              <br>
              <br>
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="alamat_suplier" id="alamat_suplier" class="form-control" autocomplete="off">
                </div>
              </div>
              <br>
              <br>
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="telp_suplier" id="telp_suplier" class="form-control" autocomplete="off">
                </div>
              </div>
              <br>
              <br>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <label class="control-label col-md-3">Nama suplier</label>
                <div class="col-md-8">
                  <input type="text" id="u_nama_suplier" class="form-control" autocomplete="off">
                  <input type="hidden" name="u_id_suplier" id="u_id_suplier">
                </div>
              </div>
              <br>
              <br>
              <div class="form-group">
                <label class="control-label col-md-3">Alamat suplier</label>
                <div class="col-md-8">
                  <input type="text" id="u_alamat_suplier" class="form-control" autocomplete="off">
                </div>
              </div>
              <br>
              <br>
              <div class="form-group">
                <label class="control-label col-md-3">Telp suplier</label>
                <div class="col-md-8">
                  <input type="text" id="u_telp_suplier" class="form-control" autocomplete="off">
                </div>
              </div>
              <br>
              <br>
      ...
      <div class="modal fade" id="modal-hapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <input type="hidden" name="d_id_suplier" id="d_id_suplier">
              <center>
...
<script>
  $(document).ready(function(){
    ...
    function tampil(){
      $.ajax({
        type: 'GET',
        url: '<?= base_url('master/show_suplier') ?>',
        dataType: 'JSON',
    ...
    $('#nama_suplier').on('keyup', function(e){
      if(e.keyCode == 13){
        simpan();
      }
    });
    ...
    function simpan(){
      ...
      var alamat_suplier = $('#alamat_suplier').val();
      var telp_suplier = $('#telp_suplier').val();
      $.ajax({
        type: 'POST',
        url: '<?= base_url('master/save_suplier') ?>',
        dataType: 'JSON',
        data:{
        ...
        success: function(data){
          if(data == 'duplikasi'){
            alert('suplier '+nama_suplier+' sudah ada di dalam database !');
          }else{
            $('#nama_suplier').val('');
    ...
    $(document).on('click', '.btn-edit', function(){
      var id_suplier = $(this).attr('data');
      $.ajax({
        type: 'POST',
        url: '<?= base_url('master/detail_suplier') ?>',
        dataType: 'JSON',
        data: {id_suplier:id_suplier},
        success: function(data){
          $('#u_id_suplier').val(data.id_suplier);
          $('#u_nama_suplier').val(data.nama_suplier);
          $('#u_alamat_suplier').val(data.alamat_suplier);
          $('#u_telp_suplier').val(data.telp_suplier);
    ...
    $('#u_nama_suplier').on('keyup', function(e){
      if(e.keyCode == 13){
        update();
      }
    });
    ...
    function update(){
      ...
      var nama_suplier = $('#u_nama_suplier').val();
      var alamat_suplier = $('#u_alamat_suplier').val();
      var telp_suplier = $('#u_telp_suplier').val();
      $.ajax({
        type: 'POST',
        url: '<?= base_url('master/update_suplier') ?>',
        dataType: 'JSON',
        data:{
    ...
    $(document).on('click', '#hapus', function(){
      var id_suplier = $('#d_id_suplier').val()
      $.ajax({
        type: 'POST',
        url: '<?= base_url('master/delete_suplier') ?>',
        dataType: 'JSON',
        data:{id_suplier:id_suplier},
        success: function(data){
    ...
    $('#cari').on('keyup', function(e){
      ...
      $.ajax({
        type: 'POST',
        url: '<?= base_url('master/search_suplier') ?>',
        dataType: 'JSON',
        data:{search:search},
        success: function(data){
          sukses(data);
        ...
        for(i=0; i<data.length; i++){
          html += `
            <tr>
              ...
              <td>`+data[i].alamat_suplier+`</td>
              <td>`+data[i].telp_suplier+`</td>
              <td>
                <button type="button" class="btn btn-warning btn-xs btn-edit" data="`+data[i].id_suplier+`">Edit</button>
                <button type="button" class="btn btn-danger btn-xs btn-hapus" data="`+data[i].id_suplier+`">Hapus</button>
