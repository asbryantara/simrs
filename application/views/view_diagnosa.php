          ...
          <div id="hasil" class="box box-primary">
            <div class="box-header">
              <div class="pull-right">
                ...
                <button type="button" name="excel" class="btn btn-success btn-sm" onclick="submitForm('diagnosa_excel');"><i class="fa fa-file-excel-o"></i>&nbsp; Excel</button>
            ...
            <div class="box-body">
              <center><h3>Grafik 10 Besar Diagnosis</h3></center>
              <div class="chart">
