    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php endif ?>
          <?= form_open(base_url('laporan/view_dokter'), ['name' => 'form_laporan','class'=>'form-horizontal', 'id'=>'form_filter']) ?>
          ...
          <div id="hasil" class="box box-primary">
            <div class="box-header">
              <div class="pull-right">
                ...
                <button type="button" name="excel" class="btn btn-success btn-sm" onclick="submitForm('dokter_excel');"><i class="fa fa-file-excel-o"></i>&nbsp; Excel</button>
