    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php endif ?>
          <?= form_open(base_url('laporan/view_lab'), ['name' => 'form_laporan','class'=>'form-horizontal', 'id'=>'form_filter']) ?>
          ...
          <div id="hasil" class="box box-primary">
            <div class="box-header">
              <div class="pull-right">
                ...
                <button type="button" name="excel" class="btn btn-success btn-sm" onclick="submitForm('lab_excel');"><i class="fa fa-file-excel-o"></i>&nbsp; Excel</button>
            ...
            <div class="box-body">
              <center><h3>Grafik Pemeriksaan Laboratorium</h3></center>
              <div class="chart">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#lap_lab').addClass('active');
  
    
    var areaChartData = {
      labels  : ['Kolesterol', 'GDA', 'GD2PP', 'GDP', 'HB', 'Trombosit', 'SGOT', 'SGPT', 'Asam Urat', 'Widal'],
      datasets: [
        
        {
          ...
          data                : [<?= $kol.', '.$gda.', '.$gdsm.', '.$gdp.', '.$hb.', '.$trombosit.', '.$sgot.', '.$sgpt.', '.$asamurat.', '.$widal ?>]
        }
      ]
    }
